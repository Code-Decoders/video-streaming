...
const MarketPlace = ({ data }) => {
  ...
  return (
    <div
      style={{ display: "flex", flexDirection: "column", paddingLeft: "35px" }}
    >
      ...
      >
        <div>Image NFTs</div>
        <div style={{ cursor: "pointer", color: "var(--secondary-tool)" }}>
          {" "}
          See All{" "}
        </div>
      </div>
      ...
      >
        <NFTCard
          buy={getContracts}
          name="Hello"
          desc="A great game of two characters from the next gen"
          img={Image}
          alt="nothing"
        />
        <NFTCard
