...
function MyApp({ Component, pageProps }) {
  ...
  const getContext = async () => {
    ...
    if (authProvider.isLoggedIn()) {
      const privateKey = authProvider.getUserInfo().privateKey;
      // const privateKey = '2701eaf6b262cb5b661904ec25696db2caae653e6968f7066b9b0efd3684527d';

      // const provider = new Web3.providers.HttpProvider(localProvider)
      const adminKeyProvider = new HDWalletProvider(
        "51b87ddf603988a4d2baabddf049d0e8c5ed801b83968ab4efc2b04641b2ac0a",
        localProvider
      );
      const adminWeb3 = new Web3(adminKeyProvider);
      const adminAccount = adminWeb3.eth.accounts.privateKeyToAccount(
        "51b87ddf603988a4d2baabddf049d0e8c5ed801b83968ab4efc2b04641b2ac0a"
      );
