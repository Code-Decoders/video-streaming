...
const VideoPlayer = ({image, name, title, game}) => {
  ...
  <div style = {{ height: "50px", width: "50px", backgroundColor: "pink", borderRadius: "50%", marginLeft: "10px" }}>
    </div>
    <div>
        {name}
    ...
    <div style = {{ fontSize: "15px", color: "pink" }}>
      {game}
    </div>
    </div>
    </div>
    ...
    <div style = {{ display: "flex", width: "100px", alignItems: "center", justifyContent: "space-between" }}> 
